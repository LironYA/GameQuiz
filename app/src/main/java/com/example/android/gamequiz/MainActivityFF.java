...
public class MainActivityFF extends AppCompatActivity {
    ...
    QuestionsFF questionLibrary = new QuestionsFF();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.back) {
            Intent i = new Intent(MainActivityFF.this, MainActivity.class);
            startActivity(i);
        }
        if (id == R.id.reset) {
